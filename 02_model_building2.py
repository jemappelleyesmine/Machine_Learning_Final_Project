...
======================================
Load learning set (already merged in Script 1), build preprocessing pipelines,
...
print("=" * 80)
# Chosen because teacher suggests linear models are acceptable but warns about correlations.
